...
# added by authors
@click.option('--fname', help='dataset file name (.json)', type=str, default="dataset.json")

#modified by authors
def calc_metrics(ctx, network_pkl, metrics, data, mirror, gpus, verbose, fname):
    """Calculate quality metrics for previous training run or pretrained network pickle.
    ...
    # modified by authors
    if data is not None:
        args.dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data, fname=fname)
    elif network_dict['training_set_kwargs'] is not None:
        args.dataset_kwargs = dnnlib.EasyDict(network_dict['training_set_kwargs'])
        args.dataset_kwargs.fname = fname
        args.dataset_kwargs.max_size = None
        args.dataset_kwargs.xflip = False
    else:
